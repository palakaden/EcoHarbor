...
<html>
  ...
  <body>
      <%
           ...
           {
                if(p.equals(request.getParameter("txtpsswd")))
                 {
                 if(request.getParameter("txtnpsswd").equals(request.getParameter("txtrpsswd")))
                  {
               
                   String pass = "update tbl_agency set agency_password ='"+request.getParameter("txtnpsswd")+"' where agency_id ='"+session.getAttribute("Agid")+"'";
