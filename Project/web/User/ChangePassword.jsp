...
<html>
    ...
    <body>
        <%
           String p="";
           String crpass ="select*from tbl_user where user_id ='"+session.getAttribute("uid")+"'";
                 ...
                 if(request.getParameter("txtpassword").equals(request.getParameter("txtpasswords")))
                  {
                   ...
                   String pass = "update tbl_user set user_password ='"+request.getParameter("txtpassword")+"' where user_id ='"+session.getAttribute("uid")+"'";
                  ...
                  else
                  {
                     %>
                      <script>
                         ...
                         window.location.href = '../User/ChangePassword.jsp';
                       </script>
                     <%
                   }
                }
